...
func (ec *executionContext) _Query_shops(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Shop)
	fc.Result = res
	return ec.marshalNShop2ᚕᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚐShopᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNShop2ᚕᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚐShopᚄ(ctx context.Context, sel ast.SelectionSet, v []*Shop) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNShop2ᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚐShop(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNShop2ᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚐShop(ctx context.Context, sel ast.SelectionSet, v *Shop) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
