...
func (ec *executionContext) _Query_shops(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNShop2ᚕᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚋmodelᚐShopᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNShop2ᚕᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚋmodelᚐShopᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Shop) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNShop2ᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚋmodelᚐShop(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNShop2ᚖgithubᚗcomᚋpampatzoglouᚋapiᚋgraphᚋmodelᚐShop(ctx context.Context, sel ast.SelectionSet, v *model.Shop) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
